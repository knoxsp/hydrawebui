...
function loadCsvExample() {
  ...
  document.getElementById("xLabel").value = selected_columns[0];
  document.getElementById("yLabel").value = selected_columns[1];
  document.getElementById("zLabel").value = selected_columns[3];
...
function loadCsvColoredDotsExample() {
  ...
  document.getElementById("xLabel").value = selected_columns[0];
  document.getElementById("yLabel").value = selected_columns[1];
  document.getElementById("zLabel").value = selected_columns[2];
  document.getElementById("legendLabel").value = selected_columns[3]
  document.getElementById("filterLabel").value = "";
